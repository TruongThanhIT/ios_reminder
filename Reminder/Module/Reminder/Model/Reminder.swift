...
extension Reminder {
    static var testData = [
        Reminder(title: "Submit reimbursement report Submit reimbursement report Submit reimbursement report", dueDate: Date().addingTimeInterval(800.0), notes: "Don't forget about taxi receipts"),
